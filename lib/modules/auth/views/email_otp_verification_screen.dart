...
class EmailOTPVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      // If controller doesn't exist, create a new one and navigate back
      print('Controller not found, creating new one...');
      controller = Get.put(EmailAuthController(), permanent: true);
      sessionExpired = true;
    }
    
    // Ensure email and signup flow are set
    controller.userEmail.value = email;
    controller.isSignupFlow.value = isSignupFlow;
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Show error and go back if session expired
      if (sessionExpired) {
        Get.snackbar(
          "error".tr,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Subtitle with email
              Text(
                "email_otp_sent_to".trParams({'email': email}),
                textAlign: TextAlign.center,
